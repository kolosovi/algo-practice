...
public:
    std::vector<int> findOrder(int numCourses, std::vector<std::vector<int>>& prerequisites) {
        ...
        std::vector<std::vector<int>> prereq_to_courses(static_cast<std::vector<int>::size_type>(numCourses), empty);
        std::vector<int> course_to_prereq_count(static_cast<std::vector<int>::size_type>(numCourses), 0);
